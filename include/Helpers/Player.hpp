...
namespace Hk::Player
{
    ...
    DLL Action<void> AddCargo(const std::variant<uint, std::wstring_view>& player, std::wstring_view good, int count, bool mission);
    DLL Action<void> Rename(const std::variant<uint, std::wstring_view>& player, std::wstring_view newCharname, bool onlyDelete);
    ...
    DLL Action<void> SetRep(const std::variant<uint, std::wstring_view>& player, std::wstring_view repGroup, float value);
