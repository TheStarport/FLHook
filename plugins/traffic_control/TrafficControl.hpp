...
inline Permissions operator|(Permissions p1, Permissions p2)
{
    return static_cast<Permissions>(static_cast<int>(p1) | static_cast<int>(p2));
}
...
namespace Plugins
{
    ...
    class TrafficControlPlugin final : public Plugin, public AbstractUserCommandProcessor, public PacketInterface
    {
        ...
        void AddShipCargoSnapshot(ClientId client) const;
