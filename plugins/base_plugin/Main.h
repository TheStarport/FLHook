...
#define MAX_PARAGRAPHS 5
  ...
  // If 0 then base is neutral to all ships. Only ships on the ally tag list may
  // dock. If 1 then base is hostile to all ships unless they are on the ally
  // tag list. If 2 then base is neutral to all ships and any ship may dock.
  int defense_mode;
...
struct CLIENT_DATA {
  ...
  // Set to player base hash if ship is in base or was last in a player base-> 0
  // after docking at any non player base->
