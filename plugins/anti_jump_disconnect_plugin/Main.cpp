...
void LoadSettings()
{
	...
	std::string configFile = std::string(szCurDir) + "\\flhook_plugins\\Anti_Jump_Disconnect_Plugin.ini";
...
EXPORT PLUGIN_INFO* Get_PluginInfo()
{
	...
	p_PI->sName = "Anti Jump Disconnect Plugin";
	p_PI->sShortName = "Anti_Jump_Disconnect_Plugin";
	p_PI->bMayPause = true;
