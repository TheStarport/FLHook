...
// WARNING: The player "Hyperjump" aspects of this plugin only work with the Discovery Client Hook. The admin beam/pull etc. commands work fine on Vanilla though.
//
