...
void PurchaseRestrictions::LoadSettings(const std::string &scPluginCfgFile) {
  ...
  set_bEnforceIDRestrictions = IniGetB(scPluginCfgFile, "PurchaseRestrictions",
  ...
  set_wscShipPurchaseDenied = stows(IniGetS(
      ...
      "ERR You cannot buy this ship because you do not have the correct ID."));
  set_wscGoodPurchaseDenied = stows(IniGetS(
      scPluginCfgFile, "PurchaseRestrictions", "GoodPurchaseDeniedMsg",
      "ERR You cannot buy this item because you do not have the correct ID."));
