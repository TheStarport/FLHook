...
namespace Rename
{
	...
	bool UserCmd_SetMoveCharCode(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_MoveChar(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
...
namespace HyperJump
{
	...
	bool UserCmd_Survey(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_SetCoords(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_ChargeJumpDrive(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_ActivateJumpDrive(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
}
...
namespace PimpShip
{
	...
	bool UserCmd_ChangeItem(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_BuyNow(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
}
...
{
	void LoadSettings(const std::string &scPluginCfgFile);
	bool UserCmd_ShowRestarts(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_Restart(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	void Timer();
}
...
namespace GiveCash
{
	...
	bool UserCmd_DrawCash(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
}
...
namespace Message
{
	...
	bool UserCmd_LMsg(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_GMsg(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_ReplyToLastPMSender(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_SendToLastTarget(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_ShowLastPMSender(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_PrivateMsg(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_PrivateMsgID(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_FactionMsg(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_FactionInvite(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_SetChatTime(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_Time(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_CustomHelp(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
...
{
	bool UserCmd_ShowInfo(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
	bool UserCmd_SetInfo(uint iClientID, const std::wstring &wscCmd, const std::wstring &wscParam, const wchar_t *usage);
}
