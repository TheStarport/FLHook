...
REFL_AUTO(type(PlayerBonus), field(Loot, AttrNotEmptyNotWhiteSpace<std::string> {}), field(Bonus, AttrMin {0.0f}, AttrMax {100.0f}),
    field(Rep, AttrNotEmptyNotWhiteSpace<std::string> {}), field(Ships), field(Items), field(Ammo));
REFL_AUTO(type(ZoneBonus), field(Zone, AttrNotEmptyNotWhiteSpace<std::string> {}), field(Bonus, AttrMin {0.0f}, AttrMax {100.0f}),
    ...
    field(CurrentReserve, AttrMin {0.0f}, AttrMax {999'999'999.0f}), field(MaxReserve, AttrMin {0.0f}, AttrMax {999'999'999.0f}),
    field(Mined, AttrMin {0.0f}, AttrMax {999'999'999.f}));
