...
void LoadSettings()
{
	...
	std::string configFile = std::string(szCurDir) + "\\flhook_plugins\\Equipment_Utilities_Plugins.ini";
...
EXPORT PLUGIN_INFO* Get_PluginInfo()
{
	...
	p_PI->sName = "Equipment Utilities Plugins";
	p_PI->sShortName = "Equipment_Utilities_Plugins";
	p_PI->bMayPause = true;
