...
namespace Plugins::Pvp
{
	...
	// event
	void UserCmdStartFreeForAll(uint clientId, const std::wstring& param)
	{
		HK_ERROR error;
	...
	void UserCmd_AcceptFFA(uint clientId, const std::wstring& param)
	{
		// Is player in space?
		uint ship;
	...
	void UserCmdDuel(uint clientId, const std::wstring& param)
	{
	...
	void UserCmdAcceptDuel(uint clientId, const std::wstring& param)
	{
		// Is player in space?
		uint ship;
		pub::Player::GetShip(clientId, ship);
	...
	void UserCmd_Cancel(uint clientId, const std::wstring& param)
	{
		processFFA(clientId);
	...
	const std::array<USERCMD, 5> UserCmds = {{
	    {L"/acceptduel", UserCmdAcceptDuel},
	    {L"/acceptffa", UserCmd_AcceptFFA},
	    {L"/cancel", UserCmd_Cancel},
	    {L"/duel", UserCmdDuel},
	    {L"/ffa", UserCmdStartFreeForAll},
	}};
