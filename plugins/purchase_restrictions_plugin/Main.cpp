...
void LoadSettings()
{
	...
	std::string configFile = std::string(szCurDir) + "\\flhook_plugins\\Purchase_Restrictions_Plugins.ini";
...
EXPORT PLUGIN_INFO* Get_PluginInfo()
{
	...
	p_PI->sName = "Purchase Restrictions Plugins";
	p_PI->sShortName = "Purchase_Restrictions_Plugins";
	p_PI->bMayPause = true;
