...
bool HkIClientImpl::Send_FLPACKET_COMMON_ACTIVATETHRUSTERS(
  ...
  CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_COMMON_ACTIVATETHRUSTERS,
               bool, __stdcall, (uint, XActivateThrusters &), (iClientID, aq));
...
bool HkIClientImpl::Send_FLPACKET_SERVER_CREATELOOT(uint iClientID,
  ...
  CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_SERVER_CREATELOOT_AFTER, bool,
               __stdcall, (uint, FLPACKET_UNKNOWN &), (iClientID, pDunno));
...
bool HkIClientImpl::Send_FLPACKET_SERVER_CREATESHIP(
  ...
  CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_SERVER_CREATESHIP_AFTER, bool,
               , (uint, FLPACKET_CREATESHIP &), (iClientID, pShip));
...
bool HkIClientImpl::Send_FLPACKET_SERVER_CREATESOLAR(
  ...
  CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_SERVER_CREATESOLAR, bool,
               __stdcall, (uint, FLPACKET_CREATESOLAR &), (iClientID, pSolar));
...
bool HkIClientImpl::Send_FLPACKET_SERVER_GFDESTROYSCRIPTBEHAVIOR(uint iClientID,
  ...
  CALL_CLIENT_METHOD(
      Send_FLPACKET_SERVER_GFDESTROYSCRIPTBEHAVIOR(iClientID, iDunno, iDunno2));
  return reinterpret_cast<bool>(vRet);
}
...
bool HkIClientImpl::Send_FLPACKET_SERVER_GFUPDATEMISSIONCOMPUTER(uint iClientID,
  ...
  CALL_CLIENT_METHOD(
      Send_FLPACKET_SERVER_GFUPDATEMISSIONCOMPUTER(iClientID, iDunno, iDunno2));
  return reinterpret_cast<bool>(vRet);
}
...
bool HkIClientImpl::Send_FLPACKET_SERVER_MISCOBJUPDATE_3(uint iClientID,
  ...
  CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_SERVER_MISCOBJUPDATE_3, bool,
               __stdcall, (uint, uint, uint), (iClientID, iTargetID, iRank));

  CALL_CLIENT_METHOD(
      Send_FLPACKET_SERVER_MISCOBJUPDATE_3(iClientID, iTargetID, iRank));

  CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_SERVER_MISCOBJUPDATE_3_AFTER,
               bool, , (uint, uint, uint), (iClientID, iTargetID, iRank));
...
bool HkIClientImpl::Send_FLPACKET_SERVER_MISCOBJUPDATE_5(uint iClientID,
  ...
  CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_SERVER_MISCOBJUPDATE_5, bool,
               __stdcall, (uint, uint, uint),
...
bool HkIClientImpl::Send_FLPACKET_SERVER_REQUESTCREATESHIPRESP(uint iClientID,
  ...
  CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_SERVER_REQUESTCREATESHIPRESP,
               bool, __stdcall, (uint, bool, uint),
...
bool HkIClientImpl::SendPacket(uint iClientID, void *pData) {
  CALL_PLUGINS(PLUGIN_HkIClientImpl_SendPacket, bool, __stdcall, (uint, void *),
               (iClientID, pData));
