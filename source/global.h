...
// tools
EXPORT wstring stows(string scText);
EXPORT string wstos(wstring wscText);
EXPORT string itos(int i);
EXPORT string IniGetS(string scFile, string scApp, string scKey, string scDefault);
EXPORT int IniGetI(string scFile, string scApp, string scKey, int iDefault);
EXPORT bool IniGetB(string scFile, string scApp, string scKey, bool bDefault);
EXPORT void IniWrite(string scFile, string scApp, string scKey, string scValue);
EXPORT void WriteProcMem(void *pAddress, void *pMem, int iSize);
EXPORT void ReadProcMem(void *pAddress, void *pMem, int iSize);
EXPORT wstring ToLower(wstring wscStr);
EXPORT string ToLower(string scStr);
EXPORT int ToInt(wstring wscStr);
EXPORT void ConPrint(wstring wscText, ...);
EXPORT wstring XMLText(wstring wscText);
EXPORT wstring GetParam(wstring wscLine, wchar_t wcSplitChar, uint iPos);
EXPORT wstring ReplaceStr(wstring wscSource, wstring wscSearchFor, wstring wscReplaceWith);
EXPORT void IniDelSection(string scFile, string scApp);
EXPORT void IniWriteW(string scFile, string scApp, string scKey, wstring wscValue);
EXPORT wstring IniGetWS(string scFile, string scApp, string scKey, wstring wscDefault);
EXPORT wstring ToMoneyStr(int iCash);
EXPORT float IniGetF(string scFile, string scApp, string scKey, float fDefault);
EXPORT void IniGetSection(string scFile, string scApp, list<INISECTIONVALUE> &lstValues);
EXPORT float ToFloat(wstring wscStr);
