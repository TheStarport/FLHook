...
bool IClientImpl::Send_FLPACKET_SERVER_SETCASH(ClientId client, uint cash)
{
	AddLog(
		LogType::Normal,
		LogLevel::Debug,
		std::format("IClientImpl::Send_FLPACKET_SERVER_SETCASH(\n\tClientId client = {}\n\tuint cash = {}\n)", client, cash));
...
namespace IServerImplHook
{
	void __stdcall SetTarget(ClientId client, const XSetTarget& st)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SetTarget, client, st);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall TractorObjects(ClientId client, const XTractorObjects& to)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__TractorObjects, client, to);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall JettisonCargo(ClientId client, const XJettisonCargo& jc)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__JettisonCargo, client, jc);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall Shutdown()
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__Shutdown);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall OnConnect(ClientId client)
	{
		...
		if (const bool innerCheck = OnConnect__Inner(client);
			!innerCheck)
			return;
		if (!skip)
		{
...
namespace IServerImplHook
{
	void __stdcall Login(const SLoginInfo& li, ClientId client)
	{
		AddLog(
			LogType::Normal,
			LogLevel::Debug,
			wstos(std::format(L"Login(\n\tSLoginInfo const& li = {}\n\tClientId client = {}\n)", ToLogString(li), client)));

		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__Login, li, client);
...
namespace IServerImplHook
{
	void __stdcall CharacterInfoReq(ClientId client, bool _genArg1)
	{
		...
		if (const bool innerCheck = CharacterInfoReq__Inner(client, _genArg1);
			!innerCheck)
			return;
		if (!skip)
		{
...
namespace IServerImplHook
{
	void __stdcall CharacterSelect(const CHARACTER_ID& cid, ClientId client)
	{
		...
		if (const bool innerCheck = CharacterSelect__Inner(cid, client);
			!innerCheck)
			return;
		if (!skip)
		{
...
namespace IServerImplHook
{
	void __stdcall CreateNewCharacter(const SCreateCharacterInfo& _genArg1, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__CreateNewCharacter, _genArg1, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall DestroyCharacter(const CHARACTER_ID& _genArg1, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__DestroyCharacter, _genArg1, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall ReqShipArch(uint archId, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__ReqShipArch, archId, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall ReqHulatus(float status, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__ReqHulatus, status, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall ReqCollisionGroups(const st6::list<CollisionGroupDesc>& collisionGroups, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__ReqCollisionGroups, collisionGroups, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall ReqEquipment(const EquipDescList& edl, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__ReqEquipment, edl, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall ReqAddItem(uint goodId, const char* hardpoint, int count, float status, bool mounted, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__ReqAddItem, goodId, hardpoint, count, status, mounted, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall ReqRemoveItem(ushort slotId, int count, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__ReqRemoveItem, slotId, count, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall ReqModifyItem(ushort slotId, const char* hardpoint, int count, float status, bool mounted, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__ReqModifyItem, slotId, hardpoint, count, status, mounted, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall ReqSetCash(int cash, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__ReqSetCash, cash, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall ReqChangeCash(int cashAdd, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__ReqChangeCash, cashAdd, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall LocationEnter(uint locationId, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__LocationEnter, locationId, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall LocationExit(uint locationId, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__LocationExit, locationId, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall BaseInfoRequest(unsigned int _genArg1, unsigned int _genArg2, bool _genArg3)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__BaseInfoRequest, _genArg1, _genArg2, _genArg3);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall LocationInfoRequest(unsigned int _genArg1, unsigned int _genArg2, bool _genArg3)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__LocationInfoRequest, _genArg1, _genArg2, _genArg3);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall GFObjSelect(unsigned int _genArg1, unsigned int _genArg2)
	{
		AddLog(
			LogType::Normal,
			LogLevel::Debug,
			std::format("GFObjSelect(\n\tunsigned int _genArg1 = {}\n\tunsigned int _genArg2 = {}\n)", _genArg1, _genArg2));

		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__GFObjSelect, _genArg1, _genArg2);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall GFGoodVaporized(const SGFGoodVaporizedInfo& gvi, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__GFGoodVaporized, gvi, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall MissionResponse(unsigned int _genArg1, unsigned long _genArg2, bool _genArg3, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__MissionResponse, _genArg1, _genArg2, _genArg3, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall TradeResponse(const unsigned char* _genArg1, int _genArg2, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__TradeResponse, _genArg1, _genArg2, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall GFGoodBuy(const SGFGoodBuyInfo& _genArg1, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__GFGoodBuy, _genArg1, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall GFGoodSell(const SGFGoodSellInfo& _genArg1, ClientId client)
	{
		...
		if (const bool innerCheck = GFGoodSell__Inner(_genArg1, client);
			!innerCheck)
			return;
		if (!skip)
		{
...
namespace IServerImplHook
{
	void __stdcall SystemSwitchOutComplete(uint shipId, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SystemSwitchOutComplete, shipId, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall JumpInComplete(uint systemId, uint shipId)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__JumpInComplete, systemId, shipId);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall Hail(unsigned int _genArg1, unsigned int _genArg2, unsigned int _genArg3)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__Hail, _genArg1, _genArg2, _genArg3);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall SPObjUpdate(const SSPObjUpdateInfo& ui, ClientId client)
	{
		...
		if (const bool innerCheck = SPObjUpdate__Inner(ui, client);
			!innerCheck)
			return;
		if (!skip)
		{
...
namespace IServerImplHook
{
	void __stdcall SPRequestUseItem(const SSPUseItem& ui, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SPRequestUseItem, ui, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall SPRequestInvincibility(uint shipId, bool enable, InvincibilityReason reason, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SPRequestInvincibility, shipId, enable, reason, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall RequestEvent(int eventType, uint shipId, uint dockTarget, uint _genArg1, ulong _genArg2, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__RequestEvent, eventType, shipId, dockTarget, _genArg1, _genArg2, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall RequestCancel(int eventType, uint shipId, uint _genArg1, ulong _genArg2, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__RequestCancel, eventType, shipId, _genArg1, _genArg2, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall MineAsteroid(uint systemId, const Vector& pos, uint crateId, uint lootId, uint count, ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__MineAsteroid, systemId, pos, crateId, lootId, count, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall RequestCreateShip(ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__RequestCreateShip, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall SPScanCargo(const uint& _genArg1, const uint& _genArg2, uint _genArg3)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SPScanCargo, _genArg1, _genArg2, _genArg3);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall SetManeuver(ClientId client, const XSetManeuver& sm)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SetManeuver, client, sm);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall InterfaceItemUsed(uint _genArg1, uint _genArg2)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__InterfaceItemUsed, _genArg1, _genArg2);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall AbortMission(ClientId client, uint _genArg1)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__AbortMission, client, _genArg1);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall SetWeaponGroup(ClientId client, uint _genArg1, int _genArg2)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SetWeaponGroup, client, _genArg1, _genArg2);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall SetVisitedState(ClientId client, uint objHash, int state)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SetVisitedState, client, objHash, state);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall RequestBestPath(ClientId client, uint _genArg1, int _genArg2)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__RequestBestPath, client, _genArg1, _genArg2);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall RequestPlayerStats(ClientId client, uint _genArg1, int _genArg2)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__RequestPlayerStats, client, _genArg1, _genArg2);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall PopupDialog(ClientId client, uint buttonClicked)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__PopupDialog, client, buttonClicked);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall RequestGroupPositions(ClientId client, uint _genArg1, int _genArg2)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__RequestGroupPositions, client, _genArg1, _genArg2);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall SetInterfaceState(ClientId client, uint _genArg1, int _genArg2)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SetInterfaceState, client, _genArg1, _genArg2);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall RequestRankLevel(ClientId client, uint _genArg1, int _genArg2)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__RequestRankLevel, client, _genArg1, _genArg2);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall AcceptTrade(ClientId client, bool _genArg1)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__AcceptTrade, client, _genArg1);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall SetTradeMoney(ClientId client, ulong _genArg1)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__SetTradeMoney, client, _genArg1);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall AddTradeEquip(ClientId client, const EquipDesc& ed)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__AddTradeEquip, client, ed);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall DelTradeEquip(ClientId client, const EquipDesc& ed)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__DelTradeEquip, client, ed);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall RequestTrade(uint _genArg1, uint _genArg2)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__RequestTrade, _genArg1, _genArg2);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
...
namespace IServerImplHook
{
	void __stdcall StopTradeRequest(ClientId client)
	{
		...
		if (const auto skip = CallPluginsBefore<void>(HookedCall::IServerImpl__StopTradeRequest, client);
			!skip)
		{
			CALL_SERVER_PREAMBLE
				{
