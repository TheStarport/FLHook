...
bool ZoneUtilities::InZone(uint system, const Vector& pos, ZONE& rlz)
{
	...
	for (auto i = start; i != end; ++i)
	{
		 ...
		 */
		float x = pos.x * lz.transform.d[0][0] + pos.y * lz.transform.d[1][0] + pos.z * lz.transform.d[2][0] +
		    lz.transform.d[3][0];
		float y = pos.x * lz.transform.d[0][1] + pos.y * lz.transform.d[1][1] + pos.z * lz.transform.d[2][1] +
		    lz.transform.d[3][1];
		float z = pos.x * lz.transform.d[0][2] + pos.y * lz.transform.d[1][2] + pos.z * lz.transform.d[2][2] +
		    lz.transform.d[3][2];
...
void ZoneUtilities::PrintZones()
{
	...
	Console::ConInfo(L"Zone, Commodity, MinLoot, MaxLoot, Difficultly, PosX, PosY, PosZ, "
	...
	for (const auto& z : set_mmapZones)
	{
		Console::ConInfo(
		    ...
		    L"%d, %d, %2.2f\n",
		    stows(z.second.zoneNick).c_str(), stows(z.second.lootNick).c_str(), z.second.iMinLoot, z.second.iMaxLoot,
		    z.second.iLootDifficulty, z.second.pos.x, z.second.pos.y, z.second.pos.z, z.second.size.x, z.second.size.y,
		    z.second.size.z);
	}
