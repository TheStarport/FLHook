...
#define ISERVER_LOGARG_WS(a) if(set_bDebug) AddLog(fLogDebug,"     " #a ": %s", wstos((const wchar_t*)a).c_str());
#define ISERVER_LOGARG_S(a) if(set_bDebug) AddLog(fLogDebug,"     " #a ": %s", (const char*)a);
...
#define ISERVER_LOGARG_H(a) if(set_bDebug) AddLog(fLogDebug,"     " #a ": 0x%08X", (int)a);
