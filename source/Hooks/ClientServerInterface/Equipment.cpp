...
{
    Logger::Trace(std::format(L"ActivateEquip(\n\tClientId client = {}\n)", client));
...
{
    Logger::Trace(std::format(L"ReqEquipment(\n\tClientId client = {}\n)", client));
...
{
    Logger::Trace(std::format(L"FireWeapon(\n\tClientId client = {}\n)", client));
...
{
    Logger::Trace(std::format(L"SetWeaponGroup(\n\tClientId client = {}\n\tuint unk1 = 0x{:08X}\n\tint unk2 = {}\n)", client, unk1, unk2));
...
{
    Logger::Trace(std::format(L"SPRequestUseItem(\n\tClientId client = {}\n)", client));
...
{
    Logger::Trace(std::format(L"ActivateThrusters(\n\tClientId client = {}\n)", client));
...
{
    Logger::Trace(std::format(L"ActivateCruise(\n\tClientId client = {}\n)", client));
