...
void __stdcall IServerImplHook::ActivateEquip(ClientId client, const XActivateEquip& aq)
{
    ...
    TRACE(L"ActivateEquip({0})", { L"client", std::to_wstring(client.GetValue()) });
...
{
    TRACE(L"ReqEquipment({0})", { L"client", std::to_wstring(client.GetValue()) });
...
{
    TRACE(L"FireWeapon({0})", { L"client", std::to_wstring(client.GetValue()) });
...
{
    TRACE(L"SPRequestUseItem({0})", { L"client", std::to_wstring(client.GetValue()) });
...
{
    TRACE(L"ActivateThrusters({0})", { L"client", std::to_wstring(client.GetValue()) });
...
void __stdcall IServerImplHook::ActivateCruise(ClientId client, const XActivateCruise& ac)
{
    ...
    TRACE(L"ActivateCruise({0})", { L"client", std::to_wstring(client.GetValue()) });
