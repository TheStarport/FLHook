...
bool SPObjUpdateInner(const SSPObjUpdateInfo& ui, ClientId client)
{
    ...
    {
        Logger::Log(LogLevel::Trace, std::format(L"NAN found in SPObjUpdate for id={}", client));
    ...
    {
        Logger::Log(LogLevel::Trace, std::format(L"Non-normalized quaternion found in SPObjUpdate for id={}", client));
        client.Kick(L"Possible cheating detected");
        return false;
    }
    ...
    {
        Logger::Log(LogLevel::Trace, std::format(L"Ship position out of bounds in SPObjUpdate for id={}", client));
        client.Kick(L"Possible cheating detected");
        return false;
    }
