...
{
    Logger::Log(LogLevel::Trace, std::format(L"SPScanCargo(\n\tuint const& unk1 = {}\n\tuint const& unk2 = {}\n\tuint unk3 = {}\n)", unk1, unk2, unk3));
...
{
    Logger::Log(LogLevel::Trace, std::format(L"ReqRemoveItem(\n\tushort slotId = {}\n\tint count = {}\n\tClientId client = {}\n)", slotId, count, client));
...
{
    Logger::Log(LogLevel::Trace, std::format(L"JettisonCargo(\n\tClientId client = {}\n)", client));
...
{
    Logger::Log(LogLevel::Trace, std::format(L"TractorObjects(\n\tClientId client = {}\n)", client));
