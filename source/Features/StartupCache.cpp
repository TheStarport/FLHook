...
namespace StartupCache
{
	...
	using _ReadCharacterName = int(__stdcall*)(wchar_t* filename, st6::wstring* str);
	...
	static int __stdcall ReadCharacterName(wchar_t* filename, st6::wstring* str)
	{
		...
		const std::wstring accPath(&filename[accPathPrefixLength]);
