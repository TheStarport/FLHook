...
void PublicClientPatchInstall() {
...

  {
    ...
    unsigned char patch2[] = {
        0x9C, 0xA1, 0x44, 0x97, 0x67, 0x00, 0x83, 0xC0, 0xF8, 0x50, 0xFF, 0x15,
        0x70, 0x64, 0x5C, 0x00, 0x59, 0x91, 0x9D, 0x74, 0x0D, 0xA0, 0xCA, 0xEC,
        0x67, 0x00, 0x88, 0x81, 0xF9, 0x00, 0x00, 0x00, 0xEB, 0x25, 0xB0, 0x00,
        0x86, 0x81, 0xF9, 0x00, 0x00, 0x00, 0xA2, 0xCA, 0xEC, 0x67, 0x00};
  ...
  // Patch get infocard
  {
    BYTE patch[] = {0xB9, 0x00, 0x00, 0x00,
  ...
  {
          BYTE patch[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90,
  0x90, 0x90, 0x90, 0x90, 0x90 }; WriteProcMem((char*)0x1B01D0, patch,
  sizeof(patch));
  }

  {
          BYTE patch[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90,
  0x90 }; WriteProcMem((char*)0x1B01F0, patch, sizeof(patch));
  }

  {
          BYTE patch[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90,
  0x90, 0x90, 0x90 }; WriteProcMem((char*)0x1B0210, patch, sizeof(patch));
  }
...
void PublicServerClientPatchInstall() {
...

  {
    ...
    // common.dll 0A9BA3 18->00 = include external equipment in cargo size PART
    // 3 ~adoxa common.dll 0AA904 18->00 = include external equipment in cargo
    // size PART 4 ~adoxa
    BYTE patch2[] = {0x00};
